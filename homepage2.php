        ...
        <div class="row">
            <div class="col-md-6">
                <div class="banner-content-two">
                    <span class="color-white wow animate__animated animate__fadeInUp" data-wow-delay="150ms" data-wow-duration="1000ms">Stay Healthy with Good Food!</span>
                    <h1 class="color-white wow animate__animated animate__fadeInUp" data-wow-delay="100ms" data-wow-duration="1000ms">Healthy & Delicious Backed Pasta</h1>
                    <a href="contact.php" class="wow animate__animated animate__fadeInUp default-btn two" data-wow-delay="100ms" data-wow-duration="1000ms"> Get Started </a>
                    ...
                    <div class="banner-content-shape">
                        ...
                        <img src="assets/images/shape/shape7.png" alt="Images">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <img src="assets/images/about-us.png" class="logo-one" alt="Logo">
            </div>
        </div>
